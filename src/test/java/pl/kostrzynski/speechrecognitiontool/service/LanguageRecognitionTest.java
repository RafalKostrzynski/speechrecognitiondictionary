...
class LanguageRecognitionTest {
    ...
    public void languageRecognitionTest() throws APIError {
        ...
        when(languageRecognition.getRecognitionResult()).thenReturn(results);

        assertEquals(results.get(0).isReliable,languageRecognition.getRecognitionResult().get(0).isReliable);
    }
